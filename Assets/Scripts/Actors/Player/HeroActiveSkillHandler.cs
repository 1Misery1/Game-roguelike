...
namespace Game.Player
{
    public class HeroActiveSkillHandler : MonoBehaviour
    {
        ...
        private void UsePrecisionShot(Vector2 aimDir)
        {
            ...
            // 穿透箭：飞行途中逐个命中结算，而非发射瞬间判定
            PlayerProjectile.Spawn(ProjectileType.PiercingArrow, transform.position, aimDir,
                24f, 20f, 0.4f, transform.parent, info, 0f, gameObject, piercing: true);
        }
